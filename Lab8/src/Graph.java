...
public class Graph {
	...
	public boolean pathExists(Vertex u, Vertex v) {
        ...
        HashSet visited = new HashSet<Vertex>();

        for(Vertex adjVertex: adjList.get(u)) {
        ...
        while(!queue.isEmpty()) {
            ...
            for(Vertex adjVertex: adjList.get(vertex)) {
                if (adjVertex.equals(v)) {
                    return true;
                }
...
//		System.out.println(g.areAdjacent(new Vertex("A"), new Vertex("D")));

//		System.out.println(g.pathExists(new Vertex("A"), new Vertex("F")));
		System.out.println(g.isConnected());

		System.out.println(g.numConnectedComponents());
	}
}
